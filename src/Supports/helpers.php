...
if (!function_exists('exp_invalid_request')) {
    function exp_invalid_request($url, $message = null) {
        if (is_null($message)) {
            return AppException::of(ERR_REQUEST_EXCEPTION, "Request [$url] is invalid");
        }

        return AppException::of(ERR_REQUEST_EXCEPTION, "Request [$url] has an error: $message");
    }
}

if (!function_exists('exp_invalid_param')) {
    function exp_invalid_param($key) {
        return AppException::of(ERR_INVALID_PARAM, "Not found the parameter[$key] or its value is NULL.");
    }
}

if (!function_exists('exp_not_found_sign_parameter')) {
    function exp_not_found_sign_parameter() {
        return AppException::of(ERR_INVALID_SIGN, "Not found the api sign parameter");
    }
}
...
if (!function_exists('exp_expired_sign_time')) {
    function exp_expired_sign_time($sign, $timer) {
        ...
        return AppException::of(ERR_EXPIRED_SIGN, "The sign[$sign] was generated by $strTimer and has expired.");
    }
}

if (!function_exists('exp_invalid_sign_value')) {
    function exp_invalid_sign_value($sign) {
        return AppException::of(ERR_INVALID_SIGN, "The sign[$sign] is invalid.");
    }
}

if (!function_exists('exp_not_found_application_key')) {
    function exp_not_found_application_key($key) {
        return AppException::of(ERR_INVALID_APPLICATION, "Not found the application bye the key[$key]");
    }
}
